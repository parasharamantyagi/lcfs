            ...
            <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true"
                ...
                <div class="wpb_column vc_column_container vc_col-sm-12 sc_layouts_column_icons_position_left">
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper"><a id="sc_anchor_contacts" class="sc_anchor sc_anchor_visible"
                                title="Contacts" data-icon="" data-url="">Contacts</a></div>
                    </div>
                </div>
            </div>
                ...
                <div class="wpb_column vc_column_container vc_col-sm-6 sc_layouts_column_icons_position_left">
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                            <div id="sc_title_2097158351" class="sc_title_align_default sc_title sc_title_default">
                                <h6
                            ...
                            <div id="widget_contacts_1856416961"
                                ...
                                <aside id="widget_contacts_1856416961_widget" class="widget widget_contacts">
                                        ...
                                        <div class="contacts_info">
                                            ...
                                            <div class="contacts_right"><span class="contacts_phone">Phone: <a
                                                    ...
                                                    class="contacts_email">Email: <a
                                                        href="mailto:<?php echo lcfs_contacts_data('have_a_questions')['email'] ?>"><?php echo lcfs_contacts_data('have_a_questions')['email'] ?></a></span>
                                            </div>
                                        </div>
                                    </div><!-- /.contacts_wrap -->
                                </aside>
                            ...
                            <div class="vc_empty_space  hide_on_mobile" style="height: 4.2857em"><span
            ...
            <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true"
                ...
                <div
                    ...
                    <div class="vc_column-inner vc_custom_1484645490851" style="margin: 5%;">
                        <div class="wpb_wrapper">
                            <div class="vc_empty_space  hide_on_mobile" style="height: 2em"><span
                                    class="vc_empty_space_inner"></span></div>
                            <div class="vc_empty_space" style="height: 3em"><span class="vc_empty_space_inner"></span>
                            </div>
                            <div id="sc_title_67415603" class="sc_title_align_default sc_title sc_title_default">
                                <h2 class="sc_item_title sc_title_title sc_align_default sc_item_title_style_default">
                                    Get in Touch</h2>
                                <div class="sc_item_descr sc_title_descr sc_align_default">Whatever your insurance
                                    coverage needs are, we're here to help life go right. <br>
                            ...
                            <div role="form" class="wpcf7" id="wpcf7-f1398-p14-o4" lang="en-US" dir="ltr">
                                <div class="screen-reader-response">
                                    <p role="status" aria-live="polite" aria-atomic="true"></p>
                                    <ul></ul>
                                </div>
                                <form action="/index.php/contacts/#wpcf7-f1398-p14-o4" method="post"
                                    class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                    <div style="display: none;">
                                        <input type="hidden" name="_wpcf7" value="1398" />
                                        <input type="hidden" name="_wpcf7_version" value="5.4.1" />
                                        <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1398-p14-o4" />
